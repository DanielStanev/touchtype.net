/* ANSI — standard staggered layout.
 * Stagger values are absolute offsets in key-units from the num-row left edge.
 * The renderer normalises them so the topmost visible row always starts at 0.
 * width/height default to 1u if omitted. mod:true = decorative, never highlighted. */
TTData.HW.ansi = {
  id: 'ansi',
  name: 'ANSI',
  rows: [
    ...
    { name: 'home', stagger: 0.0, keys: [
      ...
      { id: 'K_ENTER',     width: 2.25, mod: true }
    ]},
    { name: 'bottom', stagger: 0.0, keys: [
      { id: 'K_LSHIFT',    width: 2.25, mod: true },
      { id: 'K_Z',         finger: 'lp' },
      { id: 'K_X',         finger: 'lr' },
      { id: 'K_C',         finger: 'lm' },
      { id: 'K_V',         finger: 'li' },
