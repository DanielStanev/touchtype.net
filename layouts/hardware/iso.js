/* ISO — same row stagger as ANSI but different key shapes.
 *
 * K_ENTER appears in both the top and home rows with different widths.
 * The engine detects the shared ID across consecutive rows and renders them
 * as a single connected key — top piece extended to bridge the row gap,
 * bottom piece with the top border removed. Because the widths differ
 * (1.5u vs 1.25u) the engine also draws the L-step border via ::after. */
TTData.HW.iso = {
  id: 'iso',
  name: 'ISO',
  rows: [
    ...
    { name: 'top', stagger: 0.0, keys: [
      ...
      // Top piece of the L-shaped Enter — wider portion
      { id: 'K_ENTER',     width: 1.5,  mod: true }
    ]},
    { name: 'home', stagger: 0.0, keys: [
      { id: 'K_CAPS',      width: 1.75, mod: true },
      ...
      { id: 'K_ISO_HASH',  finger: 'rp', mod: true },
      // Bottom piece of the L-shaped Enter — narrower portion
      { id: 'K_ENTER',     width: 1.25, mod: true }
    ]},
    { name: 'bottom', stagger: 0, keys: [
      { id: 'K_LSHIFT',    width: 1.25, mod: true },
      { id: 'K_ISO_EXTRA', finger: 'lp', mod: true },
      { id: 'K_Z',         finger: 'lp' },
      { id: 'K_X',         finger: 'lr' },
      { id: 'K_C',         finger: 'lm' },
      { id: 'K_V',         finger: 'li' },
      ...
      { id: 'K_RSHIFT',    width: 2.75, mod: true }
    ]},
