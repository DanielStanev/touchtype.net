/* ISO Ortholinear — ISO key set (extra key, ISO Enter, ISO hash) with zero row stagger. */
TTData.HW.iso_ortho = {
  id: 'iso_ortho',
  name: 'ISO Ortholinear',
  rows: [
    ...
    { name: 'bottom', stagger: 0, keys: [
      { id: 'K_LSHIFT',    width: 1.75, mod: true },
      ...
      { id: 'K_N',         finger: 'ri' },
      { id: 'K_M',         finger: 'rm' },
      { id: 'K_COMMA',     finger: 'rr' },
      { id: 'K_PERIOD',    finger: 'rp' },
      { id: 'K_SLASH',     finger: 'rp' },
      { id: 'K_RSHIFT',    width: 2.25, mod: true }
    ]},
