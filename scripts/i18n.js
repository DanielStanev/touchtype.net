...
(function (root) {
  ...
  const STR = {
    en: { lang: 'English', tagline: 'Practice touch typing.', wpm: 'wpm', acc: 'accuracy', err: 'errors', time: 'time',
      ...
      accent: 'Accent Color', fingers: 'Finger zones', nextkey: 'Next key', resting: 'Resting marks', light: 'Light', dark: 'Dark',
    ...
    bg: { lang: 'Български', tagline: 'Практикувай сляпо писане.', wpm: 'думи/минута', acc: 'точност', err: 'грешки', time: 'време',
      ...
      accent: 'Цвят ', fingers: 'Зони на пръстите', nextkey: 'Следващ клавиш', resting: 'Позиции за покой', light: 'Светла', dark: 'Тъмна',
