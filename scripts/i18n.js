...
(function (root) {
  ...
  const STR = {
    en: { lang: 'English', tagline: 'Practice touch typing.', wpm: 'wpm', acc: 'accuracy', err: 'errors', time: 'time',
      ...
      lvl_rest: 'Resting keys', lvl_home: 'Home row', lvl_home_index: 'Home + index', lvl_alpha: 'Alphabet', lvl_alpha_punct: 'Alphabet + punctuation' },
    es: { lang: 'Español', tagline: 'Practica mecanografía.', wpm: 'ppm', acc: 'precisión', err: 'errores', time: 'tiempo',
      ...
      lvl_rest: 'Teclas de reposo', lvl_home: 'Fila central', lvl_home_index: 'Central + índice', lvl_alpha: 'Alfabeto', lvl_alpha_punct: 'Alfabeto + puntuación' },
    fr: { lang: 'Français', tagline: 'Entraînez-vous à la dactylographie.', wpm: 'mpm', acc: 'précision', err: 'erreurs', time: 'temps',
      ...
      lvl_rest: 'Touches de repos', lvl_home: 'Rangée de repos', lvl_home_index: 'Repos + index', lvl_alpha: 'Alphabet', lvl_alpha_punct: 'Alphabet + ponctuation' },
    de: { lang: 'Deutsch', tagline: 'Übe das Zehnfingersystem.', wpm: 'WpM', acc: 'Genauigkeit', err: 'Fehler', time: 'Zeit',
      ...
      lvl_rest: 'Ruhetasten', lvl_home: 'Grundreihe', lvl_home_index: 'Grundreihe + Zeigefinger', lvl_alpha: 'Alphabet', lvl_alpha_punct: 'Alphabet + Satzzeichen' },
    ja: { lang: '日本語', tagline: 'タッチタイピングの練習。', wpm: 'WPM', acc: '正確さ', err: 'ミス', time: '時間',
      ...
      lvl_rest: 'ホームの定位置', lvl_home: 'ホーム行', lvl_home_index: 'ホーム＋人差し指', lvl_alpha: 'アルファベット', lvl_alpha_punct: 'アルファベット＋記号' }
  };
  root.TTi18n = {
